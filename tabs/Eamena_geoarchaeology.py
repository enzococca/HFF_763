...
MAIN_DIALOG_CLASS, _ = loadUiType(os.path.join(os.path.dirname(__file__), os.pardir, 'gui', 'ui', 'Eamena_geoarchaeology.ui'))




class Eamena_geoarchaeology(QDialog, MAIN_DIALOG_CLASS):
